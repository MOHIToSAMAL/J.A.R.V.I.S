...
Think step-by-step in a hidden scratchpad to reach the answer, but ONLY output the final concise answer.
...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=SystemChatBot + [{"role": "system", "content": RealtimeInformation()}] + messages,  # Include system prompt and realtime info.
